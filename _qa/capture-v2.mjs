...
await screenshot(page, 'platform-layout-v3-orbit-dealing-390x844')
...
await narrow.waitForTimeout(360)
await screenshot(narrow, 'platform-layout-v3-orbit-dealing-320x568')
await narrow.locator('.op-orbit__card:not([disabled])').first().waitFor()
